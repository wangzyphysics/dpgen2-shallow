...
class PrepRunCalypso(Steps):
    def __init__(
        ...
        # TODO: RunModelDevi
        self._keys = ["prep-caly-input", "run-calypso", "caly-one-step", "caly-run-model-devi"]
        self.step_keys = {}
        ii = "prep-caly-input"
...
def _prep_run_calypso(
    ...
    run_calypso = Step(
        ...
        parameters={
            ...
            "task_name": prep_caly_input.outputs.artifacts["task_names"],  # [str(caly_task.int), ...]
        },
        artifacts={
        },
    ...
    caly_one_step = Step(
        ...
        parameters={
            "block_id": prep_run_steps.inputs.parameters["block_id"],  # list of caly_inputs
            "caly_inputs": prep_run_steps.inputs.parameters["caly_inputs"],  # list of caly_inputs
            "caly_structure_path_names": run_calypso.outputs.parameters["work_dir_names"],  # list of caly_inputs
            "input_file_path_names": prep_caly_input.outputs.parameters["task_names"],
        },
        artifacts={
        },
    ...
    prep_run_steps.add(caly_one_step)
